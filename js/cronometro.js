...
const lblctrl=document.querySelectorAll(".ctrl");
if(window.screen.width<=655){
    lblSpace.remove();
    lblctrl.forEach(lbl=>{lbl.remove();});
}
...
function lapPress(){
    ...
    if(tempos.scrollHeight>tempos.clientHeight&&scrollVer){
        if(window.screen.width>655){
            ...
            document.querySelector("#parciais").style.width="91vw";
            document.querySelector("#titulos").style.marginRight="1vw";
        }
